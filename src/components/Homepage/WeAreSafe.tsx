...
const WeAreSafe: React.FC = () => {
  return (
    <div className="bg-[url(https://assets.website-files.com/6368fd9690c8a033f6d30754/63d15b1f69a4472b66e5da21_home-bg4.svg)] bg-cover py-24">
      <div className="max-w-fit mx-auto flex flex-col lg:flex-row items-center justify-between px-8">
        ...
        <div className="lg:w-1/2 p-6 rounded-2xl">
